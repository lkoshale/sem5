...
public class GJNoArguDepthFirst<R> implements GJNoArguVisitor<R> {
   ...
   //
	...
	public static HashMap<String,Data> Table = new HashMap<>();
   ...
   public R visit(VarDeclaration n) {
      ...
      if(mName==null) {
	      data.VarMap.add(cName+"$"+n.f1.f0.tokenImage); 
	  }
      //else gen temporary
